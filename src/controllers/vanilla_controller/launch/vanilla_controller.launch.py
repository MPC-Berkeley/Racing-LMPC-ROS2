...
def generate_launch_description():
    ...
    return LaunchDescription(
        [
            ...
            Node(
                package="vanilla_controller",
                executable="vanilla_controller_node_exe",
                name="vanilla_controller_node",
                output="screen",
                parameters=[
                    controller_config,
                    dt_model_config,
                    ...
                    use_sim_time,
                    {
                        "vanilla_controller_node.dt": 0.1,
                        "vanilla_controller_node.race_track_file_path": track_file,
