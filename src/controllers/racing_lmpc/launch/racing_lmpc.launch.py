...
def generate_launch_description():
    ...
    mpc_config = get_share_file(
        "racing_lmpc", "param", "sample_mpc_2.param.yaml")
    dt_model_config = (
    ...
    return LaunchDescription(
        [
            ...
            Node(
                package="racing_lmpc",
                executable="racing_lmpc_node_exe",
                name="racing_lmpc_node",
                output="screen",
                parameters=[
                    mpc_config,
                    dt_model_config,
                    ...
                    use_sim_time,
                    {
                        "racing_lmpc_node.dt": 0.1,
                        "racing_lmpc_node.race_track_file_path": track_file,
                        "racing_lmpc_node.vehicle_model_name": "single_track_planar_model",
                    },
                ],
                remappings=[
                ],
