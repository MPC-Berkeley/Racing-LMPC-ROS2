...
const RacingLMPCConfig & RacingLMPC::get_config() const
{
  return *config_.get();
}

void RacingLMPC::solve(const casadi::DMDict & in, casadi::DMDict & out, casadi::Dict & stats)
{
  using casadi::DM;
  using casadi::MX;
  using casadi::Slice;
...
void RacingLMPC::create_warm_start(const casadi::DMDict & in, casadi::DMDict & out)
{
  using casadi::DM;
  using casadi::Slice;
...
BaseVehicleModel & RacingLMPC::get_model()
{
  return *model_;
}

const bool & RacingLMPC::solved() const
{
  return solved_;
}
}  // namespace racing_lmpc
