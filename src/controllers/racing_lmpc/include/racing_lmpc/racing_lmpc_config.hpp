...
#ifndef RACING_LMPC__RACING_LMPC_CONFIG_HPP_
#define RACING_LMPC__RACING_LMPC_CONFIG_HPP_
...
{
enum RacingLMPCStepMode
{
  STEP,
  CONTINUOUS
};

struct RacingLMPCConfig
{
  typedef std::shared_ptr<RacingLMPCConfig> SharedPtr;
  ...
  RacingLMPCStepMode step_mode = RacingLMPCStepMode::STEP;
...
#endif  // RACING_LMPC__RACING_LMPC_CONFIG_HPP_
