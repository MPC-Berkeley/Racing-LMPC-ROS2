...
#ifndef RACING_LMPC__RACING_LMPC_NODE_HPP_
#define RACING_LMPC__RACING_LMPC_NODE_HPP_
...
class RacingLMPCNode : public rclcpp::Node
{
public:
  explicit RacingLMPCNode(const rclcpp::NodeOptions & options);
...
#endif  // RACING_LMPC__RACING_LMPC_NODE_HPP_
